...
messy.midwest <- read_csv("messy-midwest.csv")
clean.midwest <- read_csv("midwest.csv")
write_csv(midwest, "midwest.csv")
...
write_csv(clean1.midwest, "final-clean-midwest.csv")
...
c. I added a new column 'county_state'
...
I used the unite() to create a new column named 'county_state'. 
- Some counties have the same name across multiple states. For example, Franklin County exists in OH, IN, and IL.
- For better visualizing: when creating charts or reports, county_state provides a clearer label.
